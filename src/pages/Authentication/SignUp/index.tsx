...
const SignUp: React.FC = () => {
  ...
  async function onSubmit({ name, email, password }: any, e: any) {
    e.preventDefault();
    ...
    //   reset({ fullName: '', phone: '', password: '' });
    //   navigate(`/verify-otp/62${phone}`);
        ...
        <div className="flex flex-wrap items-center">
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-3 sm:p-12.5 xl:p-17.5">
              <h2 className="logo text-5xl text-center mb-5">PUSNAS</h2>
